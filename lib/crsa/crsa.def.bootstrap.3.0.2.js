$(function() {
    ...
    var getPlaceholderImage = function() {
        var path;
        if(isApp()) {
            path = crsaGetAppDir() + 'placeholders/img';
        } else {
    ...
    $.fn.crsa.addDefinition({
        ...
        'selector' : function($el) {
            if($el.is('div')) {
                var $p = $el.parent();
                if($p.is('.row,.form-group')) return true;
            }
        ...
        'sections' : crsaAddStandardSections({
                        ...
                        show: function($dest, obj, fn, fdef, values) {
                            ...
                            for(var n = 0; n < fields.length; n++) {
                                ...
                                for(var m = 0; m < sizes.length; m++) {
                                    ...
                                    $.fn.crsa("addInputField", $td, obj, field, createColumnSpans(field_names[n], "col-" + sizes[m] + fields[n], true), values);
                                }
                            }
                        }
                    }
            ...
            layout_phone : {
                ...
                fields : {
                    ...
                    offset_xs : createColumnSpans("Offs", "col-xs-offset", true),
                    push_xs : createColumnSpans("Push", "col-xs-push", true),
                    pull_xs : createColumnSpans("Pull", "col-xs-pull", true),
                    span_sm : createColumnSpans("Span", "col-sm", true),
                    offset_sm : createColumnSpans("Offs", "col-sm-offset", true),
                    push_sm : createColumnSpans("Push", "col-sm-push", true),
                    pull_sm : createColumnSpans("Pull", "col-sm-pull", true),
                    span_md : createColumnSpans("Span", "col-md", true),
                    offset_md : createColumnSpans("Offs", "col-md-offset", true),
                    push_md : createColumnSpans("Push", "col-md-push", true),
                    pull_md : createColumnSpans("Pull", "col-md-pull", true),
                    span_lg : createColumnSpans("Span", "col-lg", true),
                    offset_lg : createColumnSpans("Offs", "col-lg-offset", true),
                    push_lg : createColumnSpans("Push", "col-lg-push", true),
                    pull_lg : createColumnSpans("Pull", "col-lg-pull", true)
                }
            }
        })
    });
    ...
    $.fn.crsa.addDefinition(secondaryText);
    ...
    $.fn.crsa.addDefinition(abbreviation);
    ...
    $.fn.crsa.addDefinition(blockquote);
    ...
    $.fn.crsa.addDefinition(glyphs_def);
    ...
    $.fn.crsa.addDefinition(description);
    ...
    $.fn.crsa.addDefinition(description_term);
    ...
    $.fn.crsa.addDefinition(description_def);
    ...
    $.fn.crsa.addDefinition(code_block);
    ...
    $.fn.crsa.addDefinition(table_head);
    ...
    $.fn.crsa.addDefinition(table_body);
    ...
    $.fn.crsa.addDefinition(table_row);
    ...
    $.fn.crsa.addDefinition(table_cell);
    ...
    var restructureForm = function($el, values) {
        ...
        $groups.each(function(i, group) {
            ...
            if($ch.length >= 2) {
                ...
                if(cls) lab.attr('class', cls.replace(/col-[a-z][a-z]-[0-9]*/ig, ''));

                cls = field.attr('class');
                var field_has_cols = cls && cls.match(/col-[a-z][a-z]-[0-9]*/ig) != null;
                if(cls && field_has_cols) field.attr('class', cls.replace(/col-[a-z][a-z]-[0-9]*/ig, ''));

                if(horiz) {
                    lab.addClass('col-sm-' + col1);
                ...
                if(cls && field_has_cols) field.attr('class', cls.replace(/col-[a-z][a-z]-[a-z\-0-9]*/ig, ''));
                ...
                if(horiz) {
                    ...
                    field.addClass('col-sm-offset-' + col1).addClass('col-sm-' + col2);
                }
            }
        });
                ...
                fields : {
                    'layout' : {
                        ...
                        set_value: function(obj, value, values, oldValue, eventType) {
                            crsaWillChangeDom();
                            var $el = obj.data;
                            $el.removeClass('form-horizontal').removeClass('form-inline').removeClass('form-normal').removeClass('navbar-form');
                            $el.addClass(value);
                            restructureForm($el, values);
                            $.fn.crsa("setNeedsUpdate", false, $el);
                        }
    ...
    $.fn.crsa.addDefinition(form_group);
    ...
    $.fn.crsa.addDefinition(form_ta_group);
    ...
    $.fn.crsa.addDefinition(form_input);
    ...
    $.fn.crsa.addDefinition(form_textarea);
    ...
    $.fn.crsa.addDefinition(form_checkbox_group);
    ...
    $.fn.crsa.addDefinition(form_checkbox);
    ...
    $.fn.crsa.addDefinition(form_radio_group);
    ...
    $.fn.crsa.addDefinition(form_radio);
    ...
    $.fn.crsa.addDefinition(form_select_group);
    ...
    $.fn.crsa.addDefinition(form_select);
    ...
    $.fn.crsa.addDefinition(form_option);
    ...
    $.fn.crsa.addDefinition(form_static_group);
    ...
    $.fn.crsa.addDefinition(form_static);
    ...
    $.fn.crsa.addDefinition(form_label);
    ...
    $.fn.crsa.addDefinition(form_fieldset);
    ...
    $.fn.crsa.addDefinition(form_help);
    ...
    $.fn.crsa.addDefinition(form_naked_checkbox);
    ...
    $.fn.crsa.addDefinition(form_naked_radio);
    ...
    $.fn.crsa.addDefinition(form_input_group);
    ...
    $.fn.crsa.addDefinition(button_dropdown);
    ...
    $.fn.crsa.addDefinition(button_dropdown_item);
    ...
    $.fn.crsa.addDefinition(button_group);
    ...
    $.fn.crsa.addDefinition(button_toolbar);
    ...
    $.fn.crsa.addDefinition(close_button);
    ...
    (function() {
        ...
        $.fn.crsa.addDefinition(list_item);
...
\
                ...
                navbar : {
                    ...
                    fields : {
                        collapse : {
                            ...
                            get_value: function(obj) {
                                var $el = obj.data;
                                return $el.find('> .navbar-header').length > 0 ? '1' : null;
                            },
                            set_value: function(obj, value, values) {
                                crsaWillChangeDom();
                                var $el = obj.data;
                                if(value) {
                                    ...
                                    if($header.length == 0) {
                                        $header = $('<div/>', {class: 'navbar-header'}).prependTo($el);
                                    }
                                    var $brand = $el.find('.navbar-brand');
                                    if($brand.length > 0) {
                                        if($header.has($brand).length == 0) {
                                            $brand.appendTo($header);
                                        }
                                    }
                                    var $content = $el.find('> div.navbar-collapse');
                                    var cid = $content.attr('id');
                                    if(!cid) cid = getUniqueId();
                                    if($content.length == 0) {
                                        $content = $('<div/>', {class: "collapse navbar-collapse", id: cid }).appendTo($el);
                                    }
                                    var $button = $el.find('.navbar-toggle');
                                    if($button.length == 0) {
                                        $button = $('<button/>', {class: 'navbar-toggle', 'data-toggle' : "collapse",  'data-target' : cid}).html('<span class="sr-only">Toggle navigation</span>\
                        <span class="icon-bar"></span>\
                        <span class="icon-bar"></span>\
                        <span class="icon-bar"></span>');
                                    }
                                    ...
                                    $el.children().each(function(i, e) {
                                        if(e != $header.get(0) && e != $content.get(0)) {
                                            $(e).appendTo($content);
                                        }
                                    });
                                    ...
                                    var $content = $el.find('> div.navbar-collapse');
                                    $header.children().each(function(i, e) {
                                        $(e).prependTo($el);
                                    });
        ...
        $.fn.crsa.addDefinition(dropdown);
...
*/
    ...
    var setCssValueForShorthandable = function(rule, f, sf, v, base_on_equal) {
        ...
        if(split_dec) {
            ...
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-left', left, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-right', right, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-top', top, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-bottom', bottom, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f, null);
            ...
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-left', null, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-right', null, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-top', null, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f + '-bottom', null, null, true);
            $.fn.crsacss('lessRuleValueChanged', rule, f, nv);
        }
        return v;
    }
    ...
    var setCssBackgroundValue = function(rule, sf, v) {
        ...
        var f = 'background-' + sf;
        if(rule.values[f]) {
            $.fn.crsacss('lessRuleValueChanged', rule, f, v);
        } else {
            if(false && rule.values['background']) {
                ...
                $.each(list, function(i, listsf) {
                    ...
                    $.fn.crsacss('lessRuleValueChanged', rule, 'background-' + listsf, val, null, true);
                });
                $.fn.crsacss('lessRuleValueChanged', rule, 'background', null);
            } else {
                $.fn.crsacss('lessRuleValueChanged', rule, f, v);
            }
        }
...
//variables
$.fn.crsa.addVariablesSection('custom', 'Custom variables');
$.fn.crsa.addVariable('@test', '@test', 'text', '100px', 'custom');
//$.fn.crsa.addVariable('@a', '@a', 'text', '100px', 'custom');
...
$.fn.crsa.addLibSection('bsgrid', 'Grid<small> / Bootstrap</small>');
$.fn.crsa.addElementsToLibSection('bsgrid', ['bs-container','bs-row','bs-column','thumbnail-img', 'thumbnail-content', 'bs-clear']);

    $.fn.crsa.addLibSection('bsbuttons', 'Bootstrap<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bsbuttons', ['bs-button' ,'img', 'button-close', 'caret', 'button-toolbar', 'button-group', 'button-dropdown','button-dropdown-item']);

    $.fn.crsa.addLibSection('bstypo', 'Text &amp; Images<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bstypo', ['h1','h2','h3','h4','h5','h6','small', 'page-header', 'p', 'link', 'anchor', 'abbr','address','blockquote', 'glyphicon','img','hr']);

    $.fn.crsa.addLibSection('bsui', 'UI elements<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bsui', ['span-label', 'badge', 'alert', 'progress', 'progress-bar', 'media', 'media-list', 'media-list-item', 'list-group', 'list-group-item', 'panel', 'panel-heading', 'panel-footer', 'well']);

    $.fn.crsa.addLibSection('bslists', 'Lists<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bslists', ['list', 'list_item', 'description', 'description-term', 'description-def']);

    $.fn.crsa.addLibSection('bstable', 'Tables<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bstable', ['table','thead', 'tbody', 'tr', 'td']);
    $.fn.crsa.addLibSection('bscode', 'Code<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bscode', ['code', 'code-block']);

    $.fn.crsa.addLibSection('bsform', 'Forms<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bsform', ['form', 'form-group', 'form-textarea-group', 'form-select-group', 'form-select', 'form-option', 'form-checkbox-group', 'form-radio-group', 'form-static-group', 'form-static', 'form-input', 'textarea', 'form-checkbox','form-radio', 'label', 'form-fieldset', 'form-help', 'form-input-group']);

    $.fn.crsa.addLibSection('bsnavbar', 'Navigation<small> / Bootstrap</small>');
    $.fn.crsa.addElementsToLibSection('bsnavbar', ['navbar','tabs', 'breadcrumb', 'pagination', 'pager', 'jumbotron']);


    //html5 elements
    var html5 = [
        {'name' : 'Sections', key: 'html-sections', els: ['section/p','nav/p','article/p','aside/p','h1','h2','h3','h4','h5','h6','header/p','footer/p','address','main/p']},
        {'name' : 'Grouping elements', key: 'html-grouping', els: ['p','hr/e','pre','blockquote','ol/p','ul/p','li','dl','dt','dd','figure','figcaption','div/p']},
        {'name' : 'Text', key: 'html-text', els: ['a','em','strong','small','s','cite','q','dfn','abbr','data','time','code','var','samp','kbd','sub','sup','i','b','u','mark','ruby','rt','rp','bdi','bdo','span','br','wbr']},
        {'name' : 'Edits', key: 'html-edits', els: ['ins','del']},
        {'name' : 'Embedded content', key: 'html-embed', els: ['img/e','iframe/e','embed/e','object/e','param/e','video/e','audio/e','source/e','track/e','canvas/e','map/e','area/e','svg/e','math']},
        {'name' : 'Tables', key: 'html-tables', els: ['table/p','caption','colgroup/p','col/p','tbody/p','thead/p','tfoot/p','tr/p','td/p','th']},
        {'name' : 'Forms', key: 'html-forms', els: ['form/p','fieldset/p','legend','label','input/e','button/e','select/e','datalist/e','optgroup/e','option/e','textarea/e','keygen/e','output/e','progress/e','meter/e']},
        {'name' : 'Interactive elements', key: 'html-interactive', els: ['details','summary','menuitem','menu/p']}
    ];
    var single = ['br', 'hr', 'wbr'];

    var html_sections = crsaAddStandardSections({});
    ...
    $.each(html5, function(i, sec) {
        ...
        $.each(sec.els, function(j, tag) {
            ...
            var cls = is_plc ? ' class="crsa-empty-placeholder"' : '';
            var inner = is_emp ? '' : tag;
            ...
            var rule = {
                ...
                empty_placeholder : is_plc,
                'name' : tag,
                priority: 2000,
                'sections' : html_sections
            }
            $.fn.crsa.addDefinition(rule);
            els.push('html-' + tag);
        });
        $.fn.crsa.addLibSection(sec.key, sec.name + '<small> / Html5</small>');


        $.fn.crsa.addElementsToLibSection(sec.key, els);
    });
...
//$.fn.crsa.addLibSection('html', 'Html');
//$.fn.crsa.addElementsToLibSection('html', ['div','img']);

$.fn.crsa.addRulesSection('buttons', 'Buttons');
$.fn.crsa.addRule('buttons','.btn','Default', {'color' : '$button_text_color'});
$.fn.crsa.addRule('buttons','.btn-primary','Primary');
$.fn.crsa.addRule('buttons','.btn-info','Info');
$.fn.crsa.addRule('buttons','.btn-success','Success');
$.fn.crsa.addRule('buttons','.btn-warning','Warning');
$.fn.crsa.addRule('buttons','.btn-danger','Danger');
$.fn.crsa.addRule('buttons','.btn-inverse','Inverse');
$.fn.crsa.addRule('buttons','.btn-link','Link');
