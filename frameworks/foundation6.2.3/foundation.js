$(function() {
    ...
    $('body').one('pinegrow-ready', function(e, pinegrow) {
        var f = new PgFramework('foundation.6.2.3', 'Foundation 6.2.3');
        f.type = "foundation";
        ...
        f.setScriptFileByScriptTagId('plugin-foundation-6-2-3'); //get url if script is included directly into edit.html
            ...
            f.addComponentType({
                ...
                on_inserted : function($el) {
                    ...
                    if (pgel.length > 0) {
                        ...
                        var goodElements = new pgQuery();

                        for (var i = 0; i < elmToMove.list.length; i++) {
                            var currentElm = elmToMove.list[i];
                            if (currentElm.pgel) {
                                goodElements.add(currentElm);
                            }
                        }
                        pgel.append(goodElements);
                    }
                },
                'sections' : crsaAddStandardSections({})
            });
                        ...
                        <ul class="dropdown menu" data-dropdown-menu="">\
                            ...
                            <li class="is-dropdown-submenu-parent opens-right">\
                                ...
                                <ul class="menu vertical submenu is-dropdown-submenu first-sub">\
                                    <li class="is-submenu-item is-dropdown-submenu-item"><a href="#">One</a></li>\
                                    <li class="is-submenu-item is-dropdown-submenu-item"><a href="#">Two</a></li>\
                                    <li class="is-submenu-item is-dropdown-submenu-item"><a href="#">Three</a></li>\
                                </ul>\
                            </li>\
                            <li><a href="#">Two</a></li>\
                            <li><a href="#">Three</a></li>\
        ...
        // Dropdown
            ...
            f.addComponentType({
                ...
                'selector' : '.is-dropdown-submenu-item',
                'helplink' : 'dropdown-menu.html',
                'code' : '<li class="is-submenu-item is-dropdown-submenu-item">\
            ...
            // Dropdown list (list)
            f.addComponentType({
                'type' : 'fd-dropdown-submenu',
                'helplink' : 'dropdown-menu.html',
                'selector' : '.is-dropdown-submenu',
                'name' : 'Dropdown submenu',
                'code' : '<ul class="menu vertical submenu is-dropdown-submenu">\
            ...
            f.addComponentType({
                ...
                'helplink' : 'dropdown-menu.html',
                'selector' : '.is-dropdown-submenu-parent',
                'name' : 'Submenu parent',
                'code' : '<li class="is-dropdown-submenu-parent">\
            ...
            dropdown_menu.sections = {
                'fd.dropdown-menu.parameters' : {
                    'name' : 'Options',
                    'fields' : getStandardPluginAction({
                        'fd.dropdown-menu.text' : {
                            'type' : 'text',
                            'name' : 'Name',
                            'attribute' : 'data-dropdown-menu',
                            'action' : 'element_attribute',
        ...
        var res = new PgComponentTypeResource('https://cdnjs.cloudflare.com/ajax/libs/foundation/6.2.3/foundation.min.css');
        res.type = 'text/css';
        f.resources.add(res);

        res = new PgComponentTypeResource('https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.4/jquery.min.js');
        res.type = 'application/javascript';
        res.detect = /jquery/;
        res.footer = true;
        f.resources.add(res);

        res = new PgComponentTypeResource('https://cdnjs.cloudflare.com/ajax/libs/foundation/6.2.3/foundation.min.js');
        res.type = 'application/javascript';
        res.footer = true;
        f.resources.add(res);
