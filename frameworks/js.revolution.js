    ...
    $('body').one('pinegrow-ready', function(e, pinegrow) {
        ...
        slider.code = function() {
            ...
            return '<div id="' + id + '" class="rev_slider">\
                <ul>\
                    <li data-transition="slideleft" data-slotamount="1" data-thumb="' + pinegrow.getThumbnailForPlaceholderImage(img1) + '">\
                        <img src="' + img1 + '">\
                    </li>\
                    <li data-transition="slideleft" data-slotamount="1" data-thumb="' + pinegrow.getThumbnailForPlaceholderImage(img2) + '">\
                        <img src="' + img2 + '">\
                    </li>\
                    <li data-transition="slideleft" data-slotamount="1" data-thumb="' + pinegrow.getThumbnailForPlaceholderImage(img3) + '">\
                        <img src="' + img3 + '">\
                    </li>\
                </ul>\
            </div>';
