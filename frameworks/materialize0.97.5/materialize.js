...
$(function() {
    ...
    $("body").one("pinegrow-ready", function(e, pinegrow) {
        ...
        var f = new PgFramework("mat0.97.5", "Materialize 0.97.5");
        ...
        res = new PgComponentTypeResource('https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/css/materialize.min.css');
        res.type = 'text/css';
        f.resources.add(res);

        res = new PgComponentTypeResource('https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/js/materialize.min.js');
