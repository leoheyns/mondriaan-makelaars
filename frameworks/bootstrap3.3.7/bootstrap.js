$(function() {
    ...
    $('body').one('pinegrow-ready', function(e, pinegrow) {
        var f = new PgFramework('bs3.3.7', 'Bootstrap 3.3.7');
        f.type = "bootstrap";
        ...
        f.setScriptFileByScriptTagId('plugin-bootstrap-3-3-7'); //get url if script is included directly into edit.html
                        ...
                        fields : {
                            ...
                            'percent' : {
                                ...
                                set_value: function(obj, value, values, oldValue, eventType) {
                                    ...
                                    if (v > 100) v = 100;
                                    value = v.toString()
                                    pgel.attr('aria-valuenow', value).attr('style', 'width:' + value + '%');
                            ...
                            'pblabel': {
                                ...
                                set_value: function(obj, value, values, oldValue, eventType) {
                                    var pgspan = '';
                                    var $parent = obj.data;
                                    var pgel = new pgQuery($parent);
                                    var $el = $parent.find('> span');
                                    if ($el.length == 0) {
                                        var pgspan = new pgQuery().create('<span></span>');
                                        pgel.html('').append(pgspan);
                                    }
                                    else {
                                        pgspan = new pgQuery($el);
                                    }
                                    pgspan.html(value);
                                    return value;
                                }
                            ...
                            'pbshowlabel': {
                                ...
                                get_value: function(obj) {
                                    var $el = obj.data.find('> span');
                                    return $el.hasClass('sr-only') ? null : '1';
                                },
                                set_value: function(obj, value, values, oldValue, eventType) {
                                    var pgel = new pgQuery(obj.data.find('> span'));
                                    if (value == 1) {
                                        pgel.removeClass('sr-only');
                                    }
                                    else {
                                        pgel.addClass('sr-only');
                                    }
                                    return value;
                                }
                            },
...
<li class="divider"></li>\
    <li><a href="#">Separated link</a></li>\
            ...
            'code' : function() {
                ...
                return '<div class="panel-group" id="' + pid + '">\
                    ...
                    <div class="panel panel-default">\
                        <div class="panel-heading">\
                            <h4 class="panel-title">\
                                <a class="collapsed" data-toggle="collapse" data-parent="#' + pid + '" href="#' + id2 + '">\
                    ...
                    <div class="panel panel-default">\
                        <div class="panel-heading">\
                            <h4 class="panel-title">\
                                <a class="collapsed" data-toggle="collapse" data-parent="#' + pid + '" href="#' + id3 + '">\
        ...
        f.addComponentType({
            ...
            'code' : function() {
                ...
                return '<div class="panel panel-default">\
                    <div class="panel-heading">\
                    <h4 class="panel-title">\
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#' + id1 + '">\
        ...
        f.on_plugin_activated = function(page, done) {
            //add editable area extension
            if(extension_added) return;
            var ext = new PgEditableAreaExtension('bs', 'Bootstrap', f);

            ext.addFieldFromProp('button-type', 'Button type', button.sections.button.fields['button-type'], '.btn');
        ...
        var res = new PgComponentTypeResource('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
        res.type = 'text/css';
        f.resources.add(res);

        res = new PgComponentTypeResource('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js');
        res.type = 'application/javascript';
        res.detect = /jquery/;
        res.footer = true;
        f.resources.add(res);

        res = new PgComponentTypeResource('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js');
        res.type = 'application/javascript';
        res.footer = true;
        f.resources.add(res);
