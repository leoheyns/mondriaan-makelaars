$(function() {
    ...
    $('body').one('pinegrow-ready', function(e, pinegrow) {
        var f = new PgFramework('foundation.6.2.0', 'Foundation 6');
        f.type = "foundation";
        ...
        f.setScriptFileByScriptTagId('plugin-foundation-6-2-0'); //get url if script is included directly into edit.html
