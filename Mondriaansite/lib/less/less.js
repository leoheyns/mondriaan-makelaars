...
//debugger;
    ...
    function $(tok) {
        ...
        if (tok instanceof Function) {
            ...
            var n = tok.call(parser.parsers);
            if(n && typeof n == 'object') {
                n.crsaSource = input.substr(start_i, i - start_i);
                n.crsaType = n.__proto__.type;
            }
            return n;
        ...
        parsers: {
            ...
            primary: function () {
                ...
                while ((node = $(this.extendRule) || $(this.mixin.definition) || $(this.rule)    ||  $(this.ruleset) ||
                    ...
                    if(typeof node == 'object') {
                        node.crsaSource = input.substr(start_i, i - start_i);
                       // console.log(node.crsaSource);
                    }
                    start_i = i;
                }
                return root;
            ...
            directive: function () {
                ...
                if (hasBlock)
                {
                    if (rules = $(this.block)) {
                        //MTCH
                        //return new(tree.Directive)(name, rules, i, env.currentFileInfo); original

                        var new_tree = new(tree.Directive)(name, rules, i, env.currentFileInfo);
                        new_tree.crsaSource = input.substr(start_i, i - start_i);
                        //console.log(new_tree.crsaSource);
                        return new_tree;
                        //end MTCH
                    }
                } else {
...
tree.Ruleset.prototype = {
    ...
    genCSS: function (env, output) {
        ...
        if (!this.root && !env.media) { //MTCH
      //      output.add('/*SPLIT*/'); //MTCH
        }
    },
...
tree.Variable.prototype = {
    type: "Variable",
    genCSS: function (env, output) { //MTCH added method
...
/*
    ...
    var fullPath = 'dummy';
    var newFileInfo = {};
    callback(null, contents, originalHref, newFileInfo, { lastModified: new Date() });
    return; //mtch import
*/
